...
# for this we need TKintet module - This module is used for creating GUI(Graphial user Interface)
...
#functions that calculate global is used to access another function
def sub():
    firstnum=e.get()
    global fnum
    global math
